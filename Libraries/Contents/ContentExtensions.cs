...
namespace OrchardCore.ContentManagement
{
    public static class ContentExtensions
    {
        ...
        {
            return content.ContentItem.As<TPart>();
        }
        ...
        {
            return content.ContentItem.GetOrCreate<TPart>();
        }
        ...
        {
            return content.ContentItem.Weld<TPart>(part);
        }
        ...
        {
            return content.ContentItem.Apply<TPart>(part);
        }
        ...
        {
            return content.ContentItem.Alter<TPart>(action);
        }
        ...
        {
            return await content.ContentItem.AlterAsync<TPart>(action);
        }
        ...
        {
            return content.ContentItem.Merge(properties, jsonMergeSettings);
        }

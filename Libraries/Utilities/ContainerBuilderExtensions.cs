...
namespace Autofac
{
     ...
     * lost because of async or building a new WorkContextScope), since that would set the HttpContext everywhere. This
     * could be much better if this is fixed: https://github.com/OrchardCMS/Orchard/issues/4338 as now we need a stub
     * HttpContext to carry the work context. See also:
     * http://stackoverflow.com/questions/8658946/autofac-lifetimes-and-the-default-provider-within-a-matching-lifetime-scope
     */

...
{
    /// <summary>
    /// A simple container for the Localizer delegate. Resolve this interface from the DI container if you want to 
    /// resolve a Localizer in-place instead of through property injection.
    /// </summary>

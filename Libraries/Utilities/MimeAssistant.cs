...
namespace Piedone.HelpfulLibraries.Utilities
{
    ...
    /// </summary>
    /// <remarks>
    /// Unlike the default implementation for <see cref="Orchard.FileSystems.Media.IMimeTypeProvider"/> this doesn't
    /// depend on the server configuration to determine a MIME type.
    /// </remarks>
    public static class MimeAssistant
    {
        ...
        /// <summary>
        /// Retrieves the MIME type for the given file name.
        /// </summary>
        /// <param name="fileName">The file name of the file, including its extension.</param>
        /// <returns>The associated MIME type, or "unknown/unknown" if none can be found.</returns>

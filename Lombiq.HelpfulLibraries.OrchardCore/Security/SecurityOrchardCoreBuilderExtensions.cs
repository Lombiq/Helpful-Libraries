...
public static class SecurityOrchardCoreBuilderExtensions
{
    ...
    ///     <item>
    ///         <description>
    ///             Adds <see cref="CdnContentSecurityPolicyProvider"/> to permit using script and style resources from
    ///             some common CDNs.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <description>
    ///             Adds <see cref="VueContentSecurityPolicyProvider"/> to permit script evaluation when the
    ///             <c>vuejs</c> resource is included.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <description>
    ///             Adds <see cref="ContentSecurityPolicyAttributeContentSecurityPolicyProvider"/> to amend the content
    ///             security policy using the <see cref="ContentSecurityPolicyAttribute"/>.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <description>
    ///             Adds <see cref="SkipContentSecurityPolicyProvider"/> to skip declaring a content security policy on
    ///             responses where it makes no sense.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <description>
    ///             Adds <see cref="BrowserLinkContentSecurityPolicyProvider"/> to permit accessing other ports on
    ///             <c>localhost</c> during local development.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <description>
    ///             Makes the session token's cookie always secure.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <description>
    ///             Makes the anti-forgery token's cookie always secure.
    ///         </description>
    ///     </item>
    ///     <item>
    ///         <description>
    ///             Enables the <c>OrchardCore.Diagnostics</c> feature to provide custom error screens in production and
    ...
    ///             all ~/Admin pages, required by the Monaco text editor widely used in admin. It can be disabled with
    ///             <see cref="ContentSecurityPolicyHeaderOptions.DisableMonacoContentSecurityPolicyProvider"/> via the
    ...
    /// </list>
    /// <para>
    /// If you also need static file support, consider using <see
    /// cref="ConfigureSecurityDefaultsWithStaticFiles(OrchardCoreBuilder, ContentSecurityPolicyHeaderConfiguration)"/>
    ...
    public static OrchardCoreBuilder ConfigureSecurityDefaultsWithStaticFiles(
        this OrchardCoreBuilder builder,
        ContentSecurityPolicyHeaderConfiguration contentSecurityPolicyHeaderConfiguration) =>
        ConfigureSecurityDefaultsInner(builder, contentSecurityPolicyHeaderConfiguration, useStaticFiles: true);

    private static OrchardCoreBuilder ConfigureSecurityDefaultsInner(
        OrchardCoreBuilder builder,
        ContentSecurityPolicyHeaderConfiguration contentSecurityPolicyHeaderConfiguration,
        bool useStaticFiles)
    {
        ...
        builder.ApplicationServices.AddInlineStartup(
            ...
            (app, _, serviceProvider) =>
            {
                ...
                app
                    .UseContentSecurityPolicyHeader(contentSecurityPolicyHeaderConfiguration)

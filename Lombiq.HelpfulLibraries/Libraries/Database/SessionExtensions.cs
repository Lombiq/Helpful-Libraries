...
namespace YesSql
{
    public static class SessionExtensions
    {
        ...
        public static Task<IEnumerable<TRow>> RawQueryAsync<TRow>(
        ...
        /// </param>
        /// <param name="parameters">Input parameters passed to the query.</param>
        /// <returns>The result set of the query, rows mapped to <typeparamref name="T"/>.</returns>
        public static Task<T> RawQueryFirstAsync<T>(
            this ISession session,
            string sql,
            IDictionary<string, object> parameters = null)
        {
        ...
        public static Task<int> RawExecuteNonQueryAsync(
            this ISession session,
        ...
        public static Task UpdateDocumentDirectlyAsync(this ISession session, int documentId, object entity)
        {
            ...
            return session.RawExecuteNonQueryAsync((_) => sql, new { Id = documentId, Content = content });
        }
    ...
    public delegate string GetSqlQuery(string prefix);
}
